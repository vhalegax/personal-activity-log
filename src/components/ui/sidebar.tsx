  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "bg-sidebar-background text-sidebar-foreground flex h-full w-[var(--sidebar-width)] flex-col",
            className,
          )}
          ref={ref}
          {...props}
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="bg-sidebar-background text-sidebar-foreground w-[var(--sidebar-width)] p-0 [&>button]:hidden"
            style={
              {
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="bg-sidebar-background group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
